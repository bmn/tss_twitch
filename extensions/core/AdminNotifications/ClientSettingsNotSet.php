 ...
 * @subpackage	[TSS] Twitch Channel Status
 * @since		16 Aug 2022
 */

namespace IPS\tsstwitch\extensions\core\AdminNotifications;
 ...
 */
class _ClientSettingsNotSet extends \IPS\core\AdminNotification
{	
	/**
	...
	{
		return 'acp_notification_ClientSettingsNotSet';
	}
	...
	{
		return 'Twitch client settings not set up';
	}
	...
	{
		return <<<'html'
<p>The Client ID and Client Secret must be set before Twitch status will work.</p>
<p>For more information, see <a href="https://dev.twitch.tv/docs/authentication/register-app">Twitch &rarr; Registering Your App</a></p>
html;
	}
